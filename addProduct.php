        ...
        if (in_array($fileActualExtension, $allowedExtensions)) {
            if ($fileError === 0) {
                ...
                if ($fileSize < 10000000000) {
                    ...
                    $sql = "INSERT INTO product (productName, Catagory, Quantity, productPrice, Image, Code) VALUES (:newProdName, :newProdCategory, :newProdQuantity, :newProdPrice, :newProdImage, :newProdCode)";
